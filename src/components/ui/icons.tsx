// Icon components for reuse across the site
...
// Feature icons mapped by name
export function FeatureIcon({ name, className = "h-6 w-6" }: { name: string; className?: string }): ReactElement {
...
// Platform icons mapped by name - Clean SVG icons matching brand guidelines
export function PlatformIcon({ name, className = "h-6 w-6" }: { name: string; className?: string }): ReactElement | null {
    const icons: Record<string, ReactElement> = {
        facebook: (
...
// Check icon used in pricing cards and other places
